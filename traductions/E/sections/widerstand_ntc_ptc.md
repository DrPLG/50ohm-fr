...
La première flèche indique une température croissante $\uparrow$. La seconde flèche indique comment se comporte la résistance lorsque la température augmente : elle peut soit augmenter $\uparrow$, soit diminuer $\downarrow$.

Le symbole $\vartheta\uparrow\uparrow$ se lit donc ainsi : lorsque la température augmente, la résistance augmente aussi. On repère ainsi un PTC (thermistance CTP). De même, $\vartheta\uparrow\downarrow$ signifie : lorsque la température augmente, la résistance diminue. Ce symbole désigne un NTC (thermistance CTN).

<margin>
[picture:1012:e_schaltbildNtcPtc:Symboles du PTC et du NTC]
</margin>
