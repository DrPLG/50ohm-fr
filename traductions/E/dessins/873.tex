...
\begin{tikzpicture}
    ...
    \draw[DARCorange]
        ...
        (out300) --
        (in320);
        \draw[decorate, decoration={text along path, text align=center, text={Trajet court}, text color=DARCgreen}]  (80:1.70) arc (80:-40:1.70) -- (-40:1.70);
        \draw[decorate, decoration={text along path, text align=center, text={Trajet long}, text color=DARCorange}] (80:1.75) arc (80:320:1.75) -- (320:1.75);
\end{tikzpicture}%