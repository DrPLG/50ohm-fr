...
\begin{circuitikz}[
    ...
    % Beschriftungen:
    \draw(ea)  node[rotate=90, align=center](hh1){\scriptsize Adaptation\\\scriptsize d'entrée};
    \draw(aa)  node[rotate=90, align=center](hh3){\scriptsize Adaptation\\\scriptsize de sortie};
