...
\begin{circuitikz}
    ...
    \draw[DARCred](mix1.north) node[anchor=south](){1\textsuperscript{er} mélangeur};
    \draw[DARCred](mix2.north) node[anchor=south](){2\textsuperscript{e} mélangeur};
    \draw[DARCred](mix3.north) node[anchor=south west](){Détecteur de produit};
\end{circuitikz}