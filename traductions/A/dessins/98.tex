...
\begin{circuitikz}
    ...
    \draw(amp2.north) node[anchor=south](){\footnotesize Étage pilote};
    \draw(mix2.north) node[anchor=south](){\footnotesize Mélangeur};
    \draw(mix1.north) node[anchor=south](h1){\footnotesize modulateur};
