...
% --------------------------------------------------------------------------
% Caractéristique de transfert I_C = beta * I_B
%
% Bei beta = 100 gilt:
...
at (axis cs:-6.4,8.2)
{Caractéristique de transfert\\$I_C \approx \beta I_B$};
...
% --------------------------------------------------------------------------
% Hilfslinien zwischen den Kennlinien und dem Point de fonctionnement
% --------------------------------------------------------------------------

% Projektion von I_B auf die Caractéristique de transfert und zum Point de fonctionnement
...
% Zugehöriger Punkt auf der Caractéristique d'entrée:
...
at (axis cs:5.0,5.0)
{\textcolor{DARCgreen}{Point de fonctionnement}};
