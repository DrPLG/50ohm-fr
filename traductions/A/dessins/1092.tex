...
\begin{tikzpicture}
    ...
    \begin{axis}[
        name=plot2,
        title={2. AM de 1: Einton moduliert Amplitude de la porteuse},
        at={(0,-2.8cm)}
    ]
    ...
    \begin{axis}[
        name=plot3,
        title={3. SSB de 1: une HF-Linie, konstante Enveloppe},
        at={(0,-5.6cm)}
    ]
    ...
    \begin{axis}[
        name=plot4,
        title={4. Zweiton-Nutzsignal NF: z.B. 700 Hz et 1200 Hz},
        at={(0,-8.4cm)}
    ]
        \addplot[DARCred]
    ...
    \begin{axis}[
        name=plot5,
        title={5. AM de 4: Zweiton moduliert Amplitude de la porteuse},
        at={(0,-11.2cm)}
    ]
    ...
    \begin{axis}[
        name=plot6,
        title={6. SSB de 4: zwei HF-Linien avec Schwebung},
        at={(0,-14.0cm)}
    ]
