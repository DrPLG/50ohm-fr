...
\begin{tikzpicture}
    ...
    \begin{axis}[
        name=plot1,
        title={1. Signal utile BF~: un ton},
        at={(0,0)}
    ]
        \addplot[DARCred]
            {sin(deg(2*pi*\fm*x))};
    ...
    \begin{axis}[
        name=plot2,
        title={2. AM de 1~: un ton module l'amplitude de la porteuse},
        at={(0,-2.8cm)}
    ]
    ...
    \begin{axis}[
        name=plot3,
        title={3. BLU de 1~: une raie HF, enveloppe constante},
        at={(0,-5.6cm)}
    ]
    ...
    \begin{axis}[
        name=plot4,
        title={4. Signal utile BF à deux tons~: p. ex. 700 Hz et 1200 Hz},
        at={(0,-8.4cm)}
    ]
        \addplot[DARCred]
    ...
    \begin{axis}[
        name=plot5,
        title={5. AM de 4~: deux tons modulent l'amplitude de la porteuse},
        at={(0,-11.2cm)}
    ]
    ...
    \begin{axis}[
        name=plot6,
        title={6. BLU de 4~: deux raies HF avec battement},
        at={(0,-14.0cm)}
    ]
