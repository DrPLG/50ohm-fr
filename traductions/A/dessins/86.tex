...
\begin{circuitikz}
    ...
    \draw(sw.out 1)
        ...
        to [piezoelectric,/tikz/circuitikz/bipoles/length=0.7cm, >] ++(0,-0.5)
        node [rground](){};
    \draw(bp1.north) node[anchor=south](){1\textsuperscript{er}\,filtre};
    ...
    \draw(mix.north) node[anchor=south](){Mélangeur};
    \draw(bp2.north) node[anchor=south](){2\textsuperscript{e}\,filtre};
