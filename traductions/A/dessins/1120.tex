...
\begin{tikzpicture}
    ...
    %
    \draw(a3) node[below](){Pertes par échauffement et courants de repos};
    \draw(a2) node[right, rotate=-90, anchor=south](){Puissance HF utile};
    \draw(a0) node[right, rotate=+90, anchor=south](){Puissance continue fournie};
\end{tikzpicture}