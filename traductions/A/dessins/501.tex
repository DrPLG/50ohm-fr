...
\begin{circuitikz}
    ...
    \draw(n3.east)
        to[short] ++(1,0)
        node [antenna](ant){};
    \draw(h1.north) ++(0,0.75) node[anchor=south](h2){\footnotesize{de contrôle}};
    \draw(h2.north)            node[anchor=south](h3){\footnotesize{Signaux de commande et}};
