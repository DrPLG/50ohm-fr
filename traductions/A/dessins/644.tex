...
\begin{circuitikz}
    \draw(2,0) 
        to [short] ++ (1,0)
        to [twoportsplit, >,     l ={\footnotesize Codeur de canal}] ++(1,0)
        to [twoportsplit, >,     l_={\footnotesize Mapper}] ++(3,0)
        to [twoportsplit,        l ={\footnotesize Codeur de source~~~~~~~~~~~}] ++(1,0) coordinate(c1);
    ...
    \draw[gray] (5.25,1.5) node(){FPGA ou Software};
\end{circuitikz}
