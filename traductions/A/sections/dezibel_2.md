...
Avec ces deux formules, nous pouvons donc convertir facilement entre indications en $\unit{\dB}$ et facteurs de rapport. Essaie maintenant de calculer les trois questions suivantes : 
