...
\begin{circuitikz}[european]
    ...
    %
    \draw [-Triangle] (c1) -- ++(-2,2) node[above,rotate=45](){Hauteur [\unit{\kilo\metre}]};
    \draw (c1) ++(-0.15,0.15) node[left,rotate=45](){jusqu'à 10};
    ...
    %
    \draw [white] (0,2.25) node[](){Terre};
    %
    \draw [-Triangle] (c0) -- ++(+2,2);
    \draw (c0) ++(+0.15,0.15) node[right,rotate=-45](){Troposphère};
    \draw (c0) ++(+0.50,0.50) node[right,rotate=-45](){Région D};
    \draw (c0) ++(+0.85,0.85) node[right,rotate=-45](){Région E};
    \draw (c0) ++(+1.42,1.42) node[right,rotate=-45](){Régions $\text{F}_1+\text{F}_2$};
    %
    \draw [Triangle-Triangle] (0,3.35) -- ++(0,1.75);
    %
    \draw (0,4.50) node [right](){Ionosphère};
    %
