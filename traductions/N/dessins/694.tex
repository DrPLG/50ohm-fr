...
\begin{circuitikz}
    ...
    \draw(0,-1-|resistor.center) node[](){Résistance};
    \draw(0,-1-|capacitor.center) node[](){Condensateur};
    \draw(0,-1-|inductor.center) node[align=center](){Bobine\\(self)};
    %
    \draw(0,-3-|diode.center) node[](){Diode};
    \draw(0,-3-|led.center) node[](){LED};
    \draw(0,-3-|switch.center) node[](){Interrupteur};
    \draw(0,-3-|transistor1.center) node[](){Transistor};
    %
    \draw(0,-5-|antenna1.center) node[](){Antenne};
    \draw(0,-5-|ground.center) node[align=center](){Masse et\\terre};
    \draw(0,-5-|vm.center) node[align=center](){Volt-\\mètre};
    \draw(0,-5-|am.center) node[align=center](){Ampère-\\mètre};
\end{circuitikz} 