...
\begin{tikzpicture}[rotate=90]
    ...
    % Begriffe
    \draw( 1.00,-0.75) node[fill=white,rotate=-90](){\small Rayonnement cosmique};
    \draw( 2.50,-1.25) node[fill=white,rotate=-90](){\small Rayons gamma};
    \draw( 5.00,-0.75) node[fill=white,rotate=-90](){\small Rayons X};
    \draw( 7.50,-1.50) node[fill=white,rotate=-90](){\small Ultraviolet};
    \draw( 8.60,-1.00) node[fill=white,rotate=-90](){\small Lumière};
    \draw( 9.75,-0.50) node[fill=white,rotate=-90](){\small Infrarouge};
    \draw(11.00,-1.00) node[fill=white,rotate=-90](){\small Rayonnement térahertz};
    \draw(12.50,-0.50) node[fill=white,rotate=-90](){\small Radar};
    \draw(13.25,-1.50) node[fill=white,rotate=-90](){\small Rayonnement micro-ondes};
    \draw(16.50,-1.00) node[fill=white,rotate=-90](){\small Ondes radio};
    \draw(20.50,-1.00) node[fill=white,rotate=-90](){\small Courants alternatifs};
