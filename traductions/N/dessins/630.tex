...
\begin{tikzpicture}
    ...
    \node at (net) {\tiny Réseau}; % Netzwerk
    ...
    \path (left4.330) -- (right4.210) node (center4b) [interface, midway] {\tiny Interface\\[-0.6em] \tiny CAT};	% Interface
    ...
    \path (left3) -- (right3) node (center3) [interface, midway] {\tiny Interface\\[-0.6em] \tiny digimode};
    ...
    \path (left2) -- (right2) node (center2) [interface, midway] {\tiny Interface\\[-0.6em] \tiny digimode};
